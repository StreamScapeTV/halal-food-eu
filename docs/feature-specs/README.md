...
Unless a section says otherwise, requirements in documents 001 through 011 and 013 through 030 are **Accepted**. Document 012 is **Future**.
...
| [025 Source-aware catalog refresh](025-source-aware-catalog-refresh.md) | source-specific cadence, accepted refresh lineage, targeted queues, conditional/delta safeguards and health integration |
...
| [030 Git-backed bundled catalog](030-git-backed-bundled-catalog.md) | rights-reviewed Git source shards, deterministic evidence/SQLite compilation, bundle packaging and test-fixture separation |
