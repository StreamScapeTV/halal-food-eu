...
class ProductionCatalogRequestTests(unittest.TestCase):
    ...
    def test_committed_schema_and_sample_are_semantically_valid(self):
        ...
        self.assertEqual(json.loads(schema.read_text(encoding="utf-8"))["type"], "object")
    ...
    def test_real_workflow_handoffs_are_digest_bound_and_snapshot_bound(self):
        ...
        evidence_path, quality_path = production_catalog_request.validate_build_handoffs(
            resolved=resolved,
